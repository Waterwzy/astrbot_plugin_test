...
class MyPlugin(Star):
    ...
    def update_user_data(self, user, waterlist):
        std_user = {
            "today_water": 0,
            "total_water": 0,
            "today_hp": 0,
        ...
        if user not in waterlist['user_data']:
    ...
    async def check_date_update(self):
        ...
        if (
            ...
            try:
                ...
                waterlist["water_boss"]["hp_add_of_yesterday"] = -50
            ...
            if message_str == "打水" or message_str == "打淼" or message_str == "打沝":
                ...
                if waterlist["water_boss"]["now_hp"] > 0:
                    if (
                        ...
                        and waterlist['user_data'][user_s]['count'] == 0
                    ):
                    ...
                    waterlist['user_data'][user_s]['count'] -= 1
                    ...
                    if waterlist["date_mon"] == 6 and waterlist["date_day"] == 30 and user_s == "3224095013":
                        kill_hp = 10
                        kill_more = 30
                    ...
                    if waterlist["water_boss"]["now_hp"] == 0 and waterlist["water_boss"]["now_hp"]<=0:
                ...
                if waterlist["date_mon"] == 7 and waterlist["date_day"] == 30 and user_s == "3224095013":
                    buff = (3,3)
                ...
                yield event.chain_result(chain)
                if obc == 3:
                    waterlist['user_data'][user_s]['count'] += level
                #'''
            elif message_str == "水表":
                TMPL = """
